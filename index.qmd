...
# Reuse the 100-simulation results from Section 3
# where `final_balances` and `initial_balance` were defined.

prob_above_original = float((final_balances > initial_balance).mean())
```
